...
export const ADMIN_URL = {
	...
	userEdit: (id: string) => ADMIN_URL.root(`users/${id}`),

	movies: () => ADMIN_URL.root('movies'),
	movieEdit: (id: string) => ADMIN_URL.root(`movies/${id}`),

	genres: () => ADMIN_URL.root('genres'),
	genreEdit: (id: string) => ADMIN_URL.root(`genres/${id}`),

	actors: () => ADMIN_URL.root('actors'),
	actorEdit: (id: string) => ADMIN_URL.root(`actors/${id}`),
